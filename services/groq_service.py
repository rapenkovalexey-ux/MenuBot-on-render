...
DIET_DESCRIPTIONS = {
    ...
    "budget":        "эконом (простые доступные продукты, бюджет до 300 руб/день, без дорогих ингредиентов — крупы, яйца, курица, сезонные овощи)",
    "student":       "студенческое (быстрые блюда до 20 минут, минимум ингредиентов, бюджетно, ситное — каши, макароны, яйца, курица)",
    "family":        "семейное (разнообразные сытные блюда для всей семьи включая детей, знакомые продукты, без экзотики)",
    "sport":         "спортивное (высокобелковое 2.0-2.5г/кг веса, умеренные углеводы, нежирное — курица, рыба, творог, яйца, крупы)",
    "detox":         "детокс (очищающее, лёгкие блюда — свежие овощи, фрукты, зелень, смузи, вода, исключить сахар, алкоголь, жирное)",
}
